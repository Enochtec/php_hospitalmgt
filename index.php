...
<!-- header logo  -->
    ...
    <a href="index.php" style="text-decoration: none;">
        <img src="assets/images/logo-main.png" alt="netcare" style="width: 100px; height: 60px;">
    </a>
    <h2 style="margin-left: 15px; font-size: 24px; color: #339; font-family: Arial, sans-serif;">
        The NetCare Hospitals
    </h2>
</header>
    ...
    <section class="banner-area">
        ...
        <div style=" margin-bottom: 15px; text-align: center;padding: 20px; color: #ffffff;">
    <h3>Follow us</h3>
    <div>
        <a href="https:/facebook.com" target="_blank" style="margin: 0 10px;">
            <img src="assets/images/2504903.png" alt="" style="width:30px; height:30px;">
        </a>
        <a href="https:/instagram.com" target="_blank" style="margin: 0 10px;">
            <img src="assets/images/Instagram_icon.png" alt="" style="width:30px; height:30px;">
        </a>
        <a href="https:/twitter.com" target="_blank" style="margin: 0 10px;">
            <img src="assets/images/X_icon_2.svg.png" alt="" style="width:30px; height:30px;">
        </a>
        <a href="https:/linkedin.com" target="_blank" style="margin: 0 10px;">
            <img src="assets/images/images.png" alt="" style="width:30px; height:30px;">
        </a>
    </div>
